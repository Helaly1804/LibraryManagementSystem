...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241012142605_createdtables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.Book", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.BookTransaction", b =>
                {
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.Penalty", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.Transaction", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.BookTransaction", b =>
                {
                    b.HasOne("LibraryManagementSysytem.Models.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementSysytem.Models.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryManagementSysytem.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("LibraryManagementSysytem.Models.Member", "Member")
                        .WithMany()
